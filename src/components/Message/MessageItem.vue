  ...
  <div class="message-item">
    <div v-if="icon" class="message-icon">
      <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em"
        ...
        <!-- info -->
        <path v-if="icon === 'info'" fill="currentColor"
        ...
        <!-- error -->
        <path v-else-if="icon === 'error'" fill="currentColor"
        ...
        <!-- warn -->
        <path v-else-if="icon === 'warn'" fill="currentColor"
        ...
        <!-- success -->
        <path v-else-if="icon === 'success'" fill="currentColor"
...
.message-item {
  ...
  @apply border-1 border-primary/20;
